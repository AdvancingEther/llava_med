...
deepspeed --master_port 26001 --include localhost:6 llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-med-v1.5-mistral-7b-vqa_rad-full-finetune-15epochs \
    --num_train_epochs 15 \
    ...
    --report_to wandb \
    --wandb_run_name "vqa-rad-finetune-lora-15epochs" \
    --wandb_project "llava-med-vqa-rad"
